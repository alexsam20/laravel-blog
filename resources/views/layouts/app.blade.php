...
<head>
    ...
    <title>{{ $metaTitle ?: 'Alexsers Blog' }}</title>
    <meta name="author" content="Alexsers">
           ...
           <div class="flex items-center">
               <form method="get" action="{{route('search')}}">
                   <input name="q" value="{{request()->get('q')}}"
                          class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-insert ring-gray-300 placeholder-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 font-medium"
...
<footer class="w-full border-t bg-white pb-12">
    <div class="w-full container mx-auto flex flex-col items-center">
        <div class="uppercase py-6">&copy; alexsers.com</div>
    </div>
</footer>
@livewireScripts
</body>
